...
public class ModBlocks {
    ...
    public static final Block FOGWOOD_SAPLING = registerBlock("fogwood_sapling",
            new SaplingBlock(new FogwoodSaplingGenerator(), FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)), ModItemGroup.MISTY_FOGLANDS);
    public static final Block FOGWOOD_LEAVES = registerBlock("fogwood_leaves",
            new LeavesBlock(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).nonOpaque()), ModItemGroup.MISTY_FOGLANDS);
    public static final Block FOGWOOD_LOG = registerBlock("fogwood_log",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD)), ModItemGroup.MISTY_FOGLANDS);
    ...
    public static final Block MISTY_GRASS = registerBlock("misty_grass",
            new Block(FabricBlockSettings.copyOf(Blocks.GRASS_BLOCK)), ModItemGroup.MISTY_FOGLANDS);
